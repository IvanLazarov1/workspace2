...
int main()
{
   ...
   cout << left << setw( 10 ) << "BookName" << setw( 10 )
      << "Year" << setw( 10 ) <<"  Price" << endl << fixed << showpoint;
...
{
   cout << left << setw( 10 ) << bookName << setw( 12 ) << year
      << setw( 5 ) << setprecision( 2 ) << right << price << endl;
